              ...
              <Col>
                <Row>
                  ...
                  <span>
                    ...
                    <a href="https://goo.gl/maps/2rkkAA9FP5pegCXF9" target="_blank" className="text-white">xyz</a>
                  </span>
                      <br/>
                      <span>
                    <BsTelephoneFill size="0.9em" className="header-line-2-icon"/>&nbsp;
                        <a href="tel:+12126583916" target="_blank" className="text-white">(000) 0000000</a>
                  </span>
                      <br/>
                      <span>
                    <GrMail className="header-line-2-icon"/>&nbsp;
                        <a href="mailto:fbatuhanr@gmail.com" target="_blank" className="text-white">abc@gmail.com</a>
                  </span>
                    </p>
